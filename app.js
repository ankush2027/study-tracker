/* =====================================================
   STUDYTRACKER — app.js
   Full PWA logic: timer, breaks, accountability,
   reminders, todos, calendar, streak, sound, PWA
   ===================================================== */
...
function setDisplay(id, show) { el(id).style.display = show ? '' : 'none'; }
...
function getRemainingMs() {
  if (!state.activeSlot) return 0;
  const elapsed = nowMs() - state.activeSlot.startTs - state.activeSlot.breakMs;
